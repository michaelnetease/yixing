...
//	public static String REQ_METHOD_TRACE = "TRACE";
	...
	public SMSCotroller(String address) throws KeyManagementException, NoSuchAlgorithmException, IOException{
	...
	public SMSCotroller addParam(String key ,String val){
