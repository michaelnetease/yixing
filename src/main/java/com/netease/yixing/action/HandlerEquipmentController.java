...
public class HandlerEquipmentController {
	...
	@RequestMapping(value = "/handlerEquipment/updataSelectedItems2", method = RequestMethod.POST)
	public Map<String, Object> updataSelectedItems2(HttpServletRequest request, @RequestBody Map updataData)
